...
Dari sisi perbandingan, evaluasi terhadap renderer lain dalam penelitian ini bersifat kualitatif pada dimensi paradigma rasterisasi, ketergantungan compute shader, dan target platform. Renderer berbasis CPU murni seperti Cairo atau Skia ditempatkan sebagai acuan paradigma rasterisasi sekuensial, sedangkan pendekatan berbasis compute shader seperti Vello ditempatkan sebagai acuan paradigma GPU compute-centric, sehingga posisi arsitektural pendekatan hibrida yang diusulkan dapat dijelaskan secara relatif terhadap kedua kutub tersebut. Perbandingan kuantitatif tatap muka (head-to-head) terhadap ketiga renderer pembanding tidak termasuk dalam cakupan penelitian ini dan diposisikan sebagai arah pengembangan lanjutan; pengukuran performa yang dilaporkan difokuskan pada dekomposisi internal waktu render purwarupa sebagaimana diuraikan pada paragraf sebelumnya.
