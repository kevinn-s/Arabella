...
use peniko::color::{AlphaColor, ColorSpaceTag, HueDirection, Srgb, gradient};
use kurbo::{Affine, Point, Vec2, Rect};
use crate::paint::math::{FloatExt, compute_erf7};
use crate::paint::paint::{Image, ImageSource, IndexedPaint, Paint, PremulColor, Tint};
use peniko::{ColorStop, ColorStops, Extend, Gradient, GradientKind, ImageQuality};
...
use crate::paint::simd::{Splat4thExt, element_wise_splat};
#[cfg(not(feature = "std"))]
